...
#
# Usage:
#   ./nccl_test.sh -N 4                                    # auto-detect
#   ./nccl_test.sh -N 4 -w ccw-gpu-[1-4]                   # specific nodes
#   SKU=graceblackwell ./nccl_test.sh -N 4                       # explicit
#   SKU=graceblackwell ./nccl_test.sh -N 4 -w ccw-gpu-[1-4]     # explicit + nodes
#
