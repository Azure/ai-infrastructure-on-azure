...
```bash
helm install dataset-prep examples/training/llm-foundry/aks/helm/dataset-download \
  --set storage.pvcName="shared-storage-pvc" \
...
```bash
helm install llm-training examples/training/llm-foundry/aks/helm/llm-training \
