...
```bash
helm install prepare-data examples/training/megatron-lm/GPT3-175B/aks/helm/prepare-data \
...
```bash
helm install megatron-training examples/training/megatron-lm/GPT3-175B/aks/helm/megatron-training \
